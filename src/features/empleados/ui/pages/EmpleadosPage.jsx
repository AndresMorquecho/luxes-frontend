        ...
        <div className="flex flex-col xs:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto shrink-0">
          {vista === 'credenciales' ? (
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2.5 bg-white border border-slate-200 text-slate-700 rounded-xl font-semibold text-sm hover:bg-slate-50 hover:border-slate-300 transition-colors shadow-sm w-full sm:w-auto"
            >
            ...
            <>
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 py-2.5 bg-violet-50 border border-violet-200 text-violet-700 rounded-xl font-semibold text-sm hover:bg-violet-100 transition-colors shadow-sm w-full sm:w-auto"
              >
              ...
              <button
                onClick={openNew}
                className="flex items-center justify-center gap-2 px-4 py-2.5 text-white rounded-xl font-semibold text-sm transition-opacity hover:opacity-90 shadow-sm w-full sm:w-auto"
