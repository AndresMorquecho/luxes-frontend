...
export const ProveedoresPage = () => {
  ...
  return (
    <div className="p-6 xl:p-8 w-full animate-slide-up" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      {/* Header */}
      <div className="pr-card px-6 py-5 flex items-center justify-between gap-4 flex-wrap mb-6">
        <div>
          <h1 className="text-2xl font-extrabold text-slate-800 tracking-tight">Proveedores</h1>
          <p className="text-sm text-slate-400 mt-0.5 font-medium">Registro y gestión de proveedores</p>
        </div>
        <button onClick={openNew} className="pr-btn-primary">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div className="pr-card px-5 py-4 flex items-center gap-4">
      ...
      <div className="pr-card">
        <div className="px-5 py-4 border-b border-slate-100/60 flex items-center gap-3">
          ...
          <input className="pr-input max-w-xs !border-0 !bg-transparent !p-0 !shadow-none !text-sm !font-medium placeholder:!text-slate-400 focus:!ring-0"
