      ...
      <div className="flex items-center justify-center gap-1.5">
        ...
        {canDelete && (
          <button
            ...
            className="w-8 h-8 inline-flex items-center justify-center rounded-lg border border-red-200 text-red-500 hover:bg-red-50 hover:text-red-700 hover:border-red-300 transition-colors cursor-pointer"
            title="Eliminar orden de compra, su deuda y cheques no cobrados"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
